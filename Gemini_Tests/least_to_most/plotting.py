...
plt.ylabel("Accuracy")
plt.title("Least to Most Accuracy by Window Size")
...
plt.xlabel("Window Size")
plt.ylabel("Macro F1")
plt.title("Least to Most Macro F1 by Window Size")
plt.xticks([1, 3, 5, 7, 9, 11])
plt.grid(True)
plt.tight_layout()
...
plt.title("Least to Most Metrics by Window Size")
...
plt.xlabel("Metric")
plt.ylabel("Score")
plt.title("Least to Most Overall Metrics")
plt.ylim(0, 1)
plt.grid(True, axis="y")
plt.tight_layout()
...
plt.ylabel("Metric Value")
plt.title("Least to Most Metrics by Emotion Label")
