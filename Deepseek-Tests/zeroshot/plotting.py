...
evaluation_file = RESULTS_DIR / "deepseek_zero_shot_results_evaluation.csv"
...
plt.ylabel("Accuracy")
plt.title("DeepSeek Zero-Shot Accuracy by Window Size")
plt.xticks([1, 3, 5, 7, 9, 11])
plt.grid(True)
plt.tight_layout()
plt.savefig(RESULTS_DIR / "deepseek_zero_shot_accuracy_by_window.png")
plt.show()
...
plt.xlabel("Window Size")
plt.ylabel("Macro F1")
plt.title("DeepSeek Zero-Shot Macro F1 by Window Size")
plt.xticks([1, 3, 5, 7, 9, 11])
plt.grid(True)
plt.tight_layout()
plt.savefig(RESULTS_DIR / "deepseek_zero_shot_macro_f1_by_window.png")
plt.show()
...
plt.title("DeepSeek Zero-Shot Metrics by Window Size")
plt.xticks(x, window_pivot["group_value"])
plt.ylim(0, 1)
plt.legend()
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "deepseek_zero_shot_metrics_by_window_bar.png")
plt.show()
...
plt.xlabel("Metric")
plt.ylabel("Score")
plt.title("DeepSeek Zero-Shot Overall Metrics")
plt.ylim(0, 1)
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "deepseek_zero_shot_overall_metrics_bar.png")
plt.show()
...
plt.ylabel("Metric Value")
plt.title("DeepSeek Zero-Shot Metrics by Emotion Label")
plt.xticks(x, label_pivot["group_value"], rotation=45)
plt.ylim(0, 1)
plt.legend()
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "deepseek_zero_shot_metrics_by_label_bar.png")
plt.show()