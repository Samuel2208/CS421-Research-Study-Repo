...
evaluation_file = RESULTS_DIR / "gemini_meld_emotion_results_evaluation.csv"
...
plt.ylabel("Accuracy")
plt.title("Gemini 2-Shot Accuracy by Window Size")
plt.xticks([1, 3, 5, 7, 9, 11])
plt.grid(True)
plt.tight_layout()
plt.savefig(RESULTS_DIR / "gemini_2shot_accuracy_by_window.png")
plt.show()
...
plt.xlabel("Window Size")
plt.ylabel("Macro F1")
plt.title("Gemini 2-Shot Macro F1 by Window Size")
plt.xticks([1, 3, 5, 7, 9, 11])
plt.grid(True)
plt.tight_layout()
plt.savefig(RESULTS_DIR / "gemini_2shot_macro_f1_by_window.png")
plt.show()
...
plt.title("Gemini 2-Shot Metrics by Window Size")
plt.xticks(x, window_pivot["group_value"])
plt.ylim(0, 1)
plt.legend()
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "gemini_2shot_metrics_by_window_bar.png")
plt.show()
...
plt.xlabel("Metric")
plt.ylabel("Score")
plt.title("Gemini 2-Shot Overall Metrics")
plt.ylim(0, 1)
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "gemini_2shot_overall_metrics_bar.png")
plt.show()
...
plt.ylabel("Metric Value")
plt.title("Gemini 2-Shot Metrics by Emotion Label")
plt.xticks(x, label_pivot["group_value"], rotation=45)
plt.ylim(0, 1)
plt.legend()
plt.grid(True, axis="y")
plt.tight_layout()
plt.savefig(RESULTS_DIR / "gemini_2shot_metrics_by_label_bar.png")
plt.show()